...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>MovieHub</b>Theatre</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer" style="background-color:black;">
                <div class="pull-right">
                  <a href="logout.php" style="border-radius:2px;background-color:red;color:white;" class="btn btn-default btn-flat">Logout</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <br>
      <center><h4 style="color: #fff;"><b>IWP DA Made By AMIT AGARWAL 19BCE0677<b></h4></center>
    </section>
    <!-- /.sidebar -->
  </aside>